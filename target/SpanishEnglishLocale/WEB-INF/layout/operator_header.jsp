...
<ul class="nav navbar-nav">
	<li id="homeActive" ><a href="${pageContext.request.contextPath}/admin/home"><spring:message code="label.home"/></a></li>
 	...
 	<li id="schoolAdminActive" ><a href="${pageContext.request.contextPath}/operator/establishments.html"><spring:message code="label.establishment"/></a></li> 
	<li id="reportActive" ><a href="${pageContext.request.contextPath}/operator/machine.html"><spring:message code="label.machine"/></a></li>
	<%-- <li id="settingActive" ><a href="${pageContext.request.contextPath}/operator/collection.html">Collection</a></li> --%>
	<li id="schoolAdminActive" ><a href="${pageContext.request.contextPath}/operator/technician.html"><spring:message code="label.technician"/></a></li>
</ul>
