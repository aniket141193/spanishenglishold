...
<script type="text/javascript">
 ...
 function showBtn(){
	 ...
	 if(saveKara == 0){
		 alert("Please select Atleast one type for delete");
	 }
	 else{
	
		 var result = confirm("Are you sure, you wan to delete type(s)?");
		 if(result){
			 window.location.href = "deleteEstablishmentType.html?list="+saveKara;	 
		 }
                   	...
                   	<center>
    					   ...
    					   <button type="button" class="close" data-dismiss="alert">x</button>
    					      <strong>Success! </strong>
   						     	Establishment Type Successfully
						</div>
					</center>             	       
                    </c:if> 
                    </div>  
                    <h1 class="page-head-text pull-left"><spring:message code="label.status"/></h1>
                    <button type="submit" class="btn btn-inverse btn-sm pull-right" data-toggle="modal" data-target="#schoolAdd"><i class="fa fa-plus-circle"></i>  <spring:message code="label.addType"/></button>                    
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                               <span class="panel-head"><spring:message code="label.typeList"/></span>                          
                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><center><spring:message code="label.typeDetails"/></center></h4>
            </div>
    
             <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/establishmentType.html" commandName="typesEstablishment">
            <div class="modal-body">
                
                      	<input type="hidden" name="action" id="action" value="add">
                    <div class="form-group">
                        <form:label path="name" class="col-sm-3 control-label"><spring:message code="label.type"/> &#42;</form:label>
                        <div class="col-sm-8">
                        	<spring:message code="tooltip.establishmentTypePH" var="i18nTooltip"/> 
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                 ...
                 <form:form id="editForm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/establishmentType.html" commandName="typesEstablishment">
            <div class="modal-body">
