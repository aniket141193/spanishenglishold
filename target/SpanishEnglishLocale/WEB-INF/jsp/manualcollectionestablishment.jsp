			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
                        ...
                        <span class="panel-head"><spring:message code="label.manualCollection"/></span>
                    </div>  
						<form
							action="${pageContext.request.contextPath}/operator/manualcollectionestablishment.html"
							method="post">
