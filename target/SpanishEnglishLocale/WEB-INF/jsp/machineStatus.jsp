...
<script type="text/javascript">
 ...
 function showBtn(){
	 ...
	 if(saveKara == 0){
		 ...
		 var result = confirm("Are you sure, you want to delete status(s)?");
		 if(result){
			 window.location.href = "deleteMachineStatus.html?list="+saveKara;	 
		 }
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
             ...
             <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/machineStatus.html" commandName="statusMachine">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                 ...
                 <form:form id="editForm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/machineStatus.html" commandName="statusMachine">
            <div class="modal-body">
