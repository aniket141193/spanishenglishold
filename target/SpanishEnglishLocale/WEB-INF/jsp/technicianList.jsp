                          ...
                          <tbody>
                          	<c:forEach var="technician" items="${technicianList}">
                                <tr>
                                    ...
                                    <td><button type="submit" class="btn btn-default btn-sm" onClick="editSchool('${technician.id}','${technician.technicianName}','${technician.address}','${technician.telephone}');"><i class="fa fa-pencil-square-o"></i> <spring:message code="label.edit"/></button></td>
                                 </tr>
                          	</c:forEach>                                                                                    
                          </tbody>
                        </table>
