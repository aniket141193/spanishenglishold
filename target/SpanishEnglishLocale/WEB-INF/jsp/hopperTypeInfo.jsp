                ...
                <div class="panel-heading clearfix">
				   ...
				   <input type="hidden" name="mvid" id="mvid" value="${mvid}">
				   		<div class="form-group">
                        	<label  class="col-sm-3 control-label"><spring:message code="label.hopperCoinMsg"/> &#42;</label>
                        	
                      		<div class="col-sm-8">
		                    	<select name="valueType" id="valueType" >
		                    		  <option value="singleCoin"><spring:message code="label.singleCoin"/></option>
									   <option value="multiCoin"><spring:message code="label.multiCoin"/></option>
