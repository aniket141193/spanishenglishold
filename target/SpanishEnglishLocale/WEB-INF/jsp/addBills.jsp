...
<div class="form-horizontal">
        ...
        <div class="col-lg-12">
            <div class="fixed-page-header">
                <div class="page-header clearfix">
                    ...
                    <h1 class="page-head-text pull-left"><spring:message code="label.bills"/></h1>
                    <h3 class="page-head-text pull-left"><spring:message code="label.billsInfo"/></h3>
    ...
    <div class="row">                        
        <div class="col-md-12">
            ...
            <form action="${pageContext.request.contextPath}/admin/addBillsMore.html" method="post">
