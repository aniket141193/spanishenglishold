                     ...
                     <table id="example" class="table table-bordered table-striped table-hover">
                          <thead>
                            ...
                            <th width="20%"><spring:message code="label.machine"/></th>
                             <th width="20%"><spring:message code="label.technician"/></th>
                             <th width="20%"><spring:message code="label.assigned"/></th>
                            </tr>
                           </thead>
                            <tbody>
                            <tr>
                             <form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/operator/assignMachinedTechnician.html">
                            <td>
                         ...
                         <td>
                         	<select name="technicianID" id="technicianID" class="form-control" >
                         		<c:forEach var="technician" items="${technicianList}">
                        			<option value="${technician.id}">${technician.technicianName}</option>
                      			</c:forEach>
                      		</select>
                      	</td>
                     	<td>
