...
@Entity
@Table(name = "OutputMoneyCoinValidator")
@Proxy(lazy=false)
public class OutputMoneyCoinValidator implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5129171378755182588L;
