...
@Entity
@Table(name = "OutputMoneyBillValidator")
@Proxy(lazy=false)
public class OutputMoneyBillValidator implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 4783107513367695961L;
