...
@Entity
@Table(name = "OutputMoneyPaymentDevice")
@Proxy(lazy=false)
public class OutputMoneyPaymentDevice implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 6552202889587878268L;
