...
public class RijndaelCrypt {
	...
	public static void main(String[] args) {
		RijndaelCrypt rc = new RijndaelCrypt("ThisIsUrPassword");

		/*
		 * String demo = "this is demo"; String encrypt =
		 * rc.encrypt(demo.getBytes()); String decrpyt = rc.decrypt(encrypt);
		 * System.out.println("decrpyt:" + decrpyt);
		 */
	...
	public String decrypt(String text) {
		...
		try {
			...
			byte[] decodedValue = Base64
					.decode(text.getBytes(), Base64.DEFAULT);
