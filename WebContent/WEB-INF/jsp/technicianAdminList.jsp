...
<script>
function goMachine(){
	 window.location.href="${pageContext.request.contextPath}/admin/assignMachinesTechnician.html";
 }
</script>
<script>
 var saveKara = 0;
 ...
 function showBtn(){
	 ...
	 if(saveKara == 0){
		 alert("Please select Atleast one technician for delete");
	 }
	 else{
	
		 var result = confirm("Are you sure, you wan to delete technician(s)?");
		 if(result){
...
function addPhone() {
		...
		element.setAttribute("onkeypress","return AllowAlphabet(event)");
...
function editSchool(id,technicianName,address,telephone){
	
	$("#Idd").val(id);
	
	$("#technicianNamee").val(technicianName);
	$("#addresss").val(address);
	$("#telephonee").val(telephone);
	window.location.href = "editTechnician.html?id="+id;
	//$("#edit").modal('show');
}
                          ...
                          <tbody>
                          	<c:forEach var="technician" items="${technicianList}">
                                <tr>
                                    ...
                                    <td>${technician.technicianUsername}</td>
                                    <td>${technician.technicianPassword}</td>
                                    <td>${technician.address}</td>
                                    <%-- <td>${technician.telephone}</td> --%>
                                    <td><c:forEach var="phone" items="${technician.phones}">${phone.type}:${phone.no},<br></c:forEach></td>
                                    <td><button type="submit" class="btn btn-default btn-sm" onClick="editSchool('${technician.id}','${technician.technicianName}','${technician.technicianUsername}','${technician.technicianPassword}','${technician.address}','${technician.telephone}');"><i class="fa fa-pencil-square-o"></i> <spring:message code="label.edit"/></button></td>
                                 </tr>
                          	</c:forEach>                                                                                    
                          </tbody>
                        </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
             ...
             <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/technician.html" commandName="technician">
            <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                       		<form:input type="text" path="technicianUsername" id="technicianUsername" value="" class="form-control" maxlength="50" onblur = "useHTML(this.id,document.getElementById('a').value)"/>
                       	</div>
                    </div>
                     <div class="form-group">
                        <form:label path="technicianPassword" class="col-sm-3 control-label"><spring:message code="label.password"/> &#42;</form:label>
                        <div class="col-sm-8">
                       		<form:input type="text" path="technicianPassword" id="technicianPassword" value="" class="form-control" maxlength="50" onblur = "useHTML(this.id,document.getElementById('a').value)"/>
                       	</div>
                    </div>
                  	<div class="form-group">
                    ...
                    <%-- <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <form:input type="text" path="telephone" id="telephonee" value="" class="form-control" maxlength="60" onblur = "useHTML(this.id,document.getElementById('c').value)"/>
                      	</div>
                    </div> --%>
                    <div class="form-group">
                        <form:label path="telephone" class="col-sm-3 control-label"><spring:message code="label.telephone"/> &#42;</form:label>
        ...
        <h4 class="modal-title"><spring:message code="label.editTechnician"/> </h4>
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <form:label path="technicianUsername" class="col-sm-3 control-label"><spring:message code="label.username"/> &#42;</form:label>
                        <div class="col-sm-8">
                       		<form:input type="text" path="technicianUsername" id="technicianUsernamee" value="" class="form-control" maxlength="50" onblur = "useHTML(this.id,document.getElementById('a').value)"/>
                       	</div>
                    </div>
                     <div class="form-group">
                        <form:label path="technicianPassword" class="col-sm-3 control-label"><spring:message code="label.password"/> &#42;</form:label>
                        <div class="col-sm-8">
                       		<form:input type="text" path="technicianPassword" id="technicianPasswordd" value="" class="form-control" maxlength="50" onblur = "useHTML(this.id,document.getElementById('a').value)"/>
                       	</div>
                    </div>
                  	<div class="form-group">
                        <form:label path="address" class="col-sm-3 control-label"><spring:message code="label.address"/> &#42;</form:label>
