                ...
                <div class="panel-heading clearfix">
				   ...
				   <input type="hidden" name="mvid" id="mvid" value="${mvid}">
				   		<div class="form-group">
                        	<label  class="col-sm-3 control-label"><spring:message code="label.billValidatorInputOrOutput"/> &#42;</label>
                        	
                      		<div class="col-sm-8">
		                    	<select name="valueType" id="valueType" >
		                    		  <option value="input"><spring:message code="label.onlyInput"/></option>
