 ...
 function showBtn(){
	 ...
	 if(saveKara == 0){
		 ...
		 if(result){
			 ...
			 window.location.href = "deleteMoney.html?list="+saveKara+"&countryId="+countryId;	 
		 }
         	...
         	<th width="3%" class="text-center no-sort"><input type="checkbox"  onClick="deleteAllRow(this)" ></th>
                          ...
                          <tbody>
                          	<c:forEach var="money" items="${moneyList}">
                                <tr>
                                  	<td class="text-center"><input type="checkbox" id="${money.id}"  name="myTextEditBox" value="" onClick="displayNote(event)"/></td>
                                    <td>${money.name}</td>
									<td>${money.value}</td>                                   
                                    <td>${money.code}</td>
                                    <td>${money.type}</td>    
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
             ...
             <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/addMoney.html" commandName="money">
            <div class="modal-body">
                        ...
                        <form:label path="name" class="col-sm-3 control-label"><spring:message code="label.type"/> &#42; </form:label>
                      	...
                      	<div class="col-sm-8">
		                    	<form:select path="type" id="type" >
		                    		  <option value="coin"><spring:message code="label.coin"/></option>
									   <option value="note"><spring:message code="label.note"/></option>
									   <option value="token"><spring:message code="label.token"/></option>
									   <%-- <option value="bill"><spring:message code="label.bill"/></option>   --%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                       		<form:input type="text" path="name" id="name" value="" class="form-control"  />
                       	</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                       		<form:input type="text" path="value" id="value" value="" class="form-control"  />
                       	</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                       		<form:input type="text" path="code" id="code" value="" class="form-control"  />
                       	</div>
                    </div>
