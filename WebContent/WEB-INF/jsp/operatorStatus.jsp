...
<script type="text/javascript">
 ...
 function showBtn(){
	 ...
	 if(saveKara == 0){
		 ...
		 if(result){
			 window.location.href = "deleteOperatorStatus.html?list="+saveKara;	 
		 }
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
             ...
             <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/operatorStatus.html" commandName="statusOperator">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                 ...
                 <form:form id="editForm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/operatorStatus.html" commandName="statusOperator">
            <div class="modal-body">
