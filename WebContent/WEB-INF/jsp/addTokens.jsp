...
<script>
 ...
 function doneCoinsName(countryId){
	...
	var value = $("#value").val();
	var name = $("#name").val();
	 window.location.href = "addTokensDone.html?countryId="+countryId+"&code="+code+"&value="+value+"&name="+name;	
 }
</script>
...
<div class="form-horizontal">
        ...
        <div class="col-lg-12">
            <div class="fixed-page-header">
                <div class="page-header clearfix">
                    ...
                    <h3 class="page-head-text pull-left"><spring:message code="label.tokenInfo"/></h3>
    ...
    <div class="row">                        
        <div class="col-md-12">
            ...
            <form action="${pageContext.request.contextPath}/admin/addTokensMore.html" method="post">
