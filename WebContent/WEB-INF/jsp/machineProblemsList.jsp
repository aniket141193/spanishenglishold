...
<script>
 ...
 function showBtn(){
	 ...
	 if(saveKara == 0){
		 alert("Please select Atleast one machine problems for delete");
	 }
	 else{
	
		 var result = confirm("Are you sure, you wan to delete machine problems?");
		 if(result){
			 window.location.href = "deleteMachineProblemsList.html?list="+saveKara;	 
		 }
                	 ...
                	 <c:if test="${error == '1'}">
                   	<center>
    					   ...
    					   <button type="button" class="close" data-dismiss="alert">x</button>
    					      <strong>ALERT! </strong>
   						     	Please remove Machine problem from Repair History.
						</div>
					</center>             	       
                    </c:if> 
                    <h1 class="page-head-text pull-left"><spring:message code="label.machineProblems"/></h1>
            ...
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                   <div class="panel-name">
                        <span class="panel-head"><spring:message code="label.machineProblemsList"/></span>
                    </div>                                        
                </div>
         	...
         	<th width="3%" class="text-center no-sort"><input type="checkbox"  onClick="deleteAllRow(this)" ></th>
                          ...
                          <tbody>
                          	<c:forEach var="machineProblems" items="${machineProblemsList}">
                                <tr>
                                  	<td class="text-center"><input type="checkbox" id="${machineProblems.id}"  name="myTextEditBox" value="" onClick="displayNote(event)"/></td>
                                    <td>${machineProblems.description}</td>
                                    <td><button type="submit" class="btn btn-default btn-sm" onClick="editSchool('${machineProblems.id}','${machineProblems.description}');"><i class="fa fa-pencil-square-o"></i> <spring:message code="label.edit"/></button></td>
                                 </tr>
                          	</c:forEach>                                                                                    
                          </tbody>
                        </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
             ...
             <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/machineProblemsList.html" commandName="machineProblems">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><spring:message code="label.editMachineParts"/> </h4>
      </div>
	   
	        <form:form id="editForm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/machineProblemsList.html" commandName="machineProblems">
            <div class="modal-body">
